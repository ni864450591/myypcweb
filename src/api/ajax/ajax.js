...
// Ajax{ 
//url,options,xhr,
//init(), bindEvents(),setResponseType(),setCookie(),setTimeout();sendData();
//bindEvents():对xhr绑定事件处理,怎么处理外面说了算
//setResponseType(), 设置xhr.responseType
//setCookie(),设置xhr.withCredentials
//setTimeout(),设置xhr.timeout 
//sendData(), //发送数据前要判断数据类型
//}
